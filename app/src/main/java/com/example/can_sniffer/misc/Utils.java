...
public class Utils {
    ...
    public static double ACCELEROMETER_DEFAULT_DEVIATION = 0.1;//оригинально стояло 0.1
    ...
    public static final double DEFAULT_SPD_FACTOR = 1;//в оригинальной работе было 1 для скорости
    public static final double DEFAULT_VEL_FACTOR = 1;//в оригинальной работе было 1
    public static final double DEFAULT_POS_FACTOR = 1.0;//оригинально было 1
    //!!
